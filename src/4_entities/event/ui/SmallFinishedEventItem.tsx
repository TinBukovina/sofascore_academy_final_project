...
export function SmallFinishedEventItem({
  event,
  favouriteBtn,
  lastChild = false,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Box fontSize={"xs"}>{formatDateFromDate(event.startDate)}</Box>
      </Flex>
      ...
      <Flex
        ...
        alignItems={"center"}
        border={"1px solid transparent"}
        borderLeftColor={{ base: "primaryClr" }}
        borderRightColor={{ base: "primaryClr" }}
        fontSize={"sm"}
      >
